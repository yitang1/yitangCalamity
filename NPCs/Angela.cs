...
namespace yitangCalamity.NPCs
{
	...
	internal class Angela : ModNPC
    {
        ...
        public override void AddShops()
        {
			...
			#region 灾厄Mod相关
			sumShop.Add(CustomPrice(ItemType<CausticTear>(), buyPrice(0, 1, 50, 0)), new Condition[] { Condition.DownedEyeOfCthulhu })
                ...
                .Add(CustomPrice(ItemType<DesertMedallion>(), buyPrice(0, 2, 0, 0)), Array.Empty<Condition>())
                .Add(CustomPrice(ItemType<DecapoditaSprout>(), buyPrice(0, 2, 0, 0)), Array.Empty<Condition>())
                .Add(CustomPrice(ItemType<SparklingTunaCan>(), buyPrice(0, 2, 50, 0)), new Condition[] { DownedDesertScourge })
                ...
                .Add(CustomPrice(ItemType<SandstormsCore>(), buyPrice(0, 4, 0, 0)), new Condition[] { Condition.DownedPlantera })
                .Add(CustomPrice(ItemType<EyeofDesolation>(), buyPrice(0, 4, 0, 0)), new Condition[] { Condition.Hardmode })
                .Add(CustomPrice(ItemType<LeviathanDetector>(), buyPrice(0, 4, 0, 0)), new Condition[] { Condition.Hardmode })
                .Add(CustomPrice(ItemType<AstralChunk>(), buyPrice(0, 4, 0, 0)), new Condition[] { Condition.Hardmode })
            ...
            sumShop.Add(CustomPrice(ItemType<ProfanedShard>(), buyPrice(0, 5, 0, 0)), new Condition[] { Condition.DownedMoonLord })
                ...
                .Add(CustomPrice(ItemType<CeremonialUrn>(), buyPrice(0, 12, 0, 0)), new Condition[] { DownedSuperCalamitas });
			#endregion
			...
			sumShop.Add(CustomPrice(ItemType<MissingPoster>(), buyPrice(0, 2, 0, 0)), Array.Empty<Condition>());
			...
			sumShop.Add(CustomPrice(ItemType<RedBait>(), buyPrice(0, 4, 0, 0)), new Condition[] { Condition.Hardmode })
				.Add(CustomPrice(ItemType<MothPheromone>(), buyPrice(0, 3, 50, 0)), new Condition[] { Condition.Hardmode })
                .Add(CustomPrice(ItemType<DemonicPlushie>(), buyPrice(0, 3, 70, 0)), new Condition[] { Condition.DownedMechBossAny });
